...
def word_count(phrase):
    """ inputs a phrase and returns dictionary with word counts """

    # make lowercase and get rid of punctuation marks
    ...
    # remove quotation marks and apostrophes if quoting a word
    for n,i in enumerate(phrase):
        if i[0]=="'" and i[-1]=="'" or i[0]=='"' and i[1]=='"':
            phrase[n] = phrase[n][1:-1]
